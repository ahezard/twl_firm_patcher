...
python ..\scripts\build_twlbg_code_from_dev_launcher_srl_n3ds.py --srl=devSRLlauncher_patched_enc.nds --code=twlBg_original_exefs\code.bin --out=twlBg_patched_exefs\code.bin 
